...
let avatar = null; // Declare avatar variable at the top
...
// Set its attributes
        ...
        function checkConditions() {
            ...
            if (inputValue.length > 0 && invited.length > 0) {
                document.getElementById('sendGroup').style.opacity = '1';
                document.getElementById('sendGroup').disabled = false;
 
                console.log("block");
            } else {
                document.getElementById('sendGroup').style.opacity = '0.5';
                document.getElementById('sendGroup').disabled = true; // Hide the button
                console.log("none");
            }
        }

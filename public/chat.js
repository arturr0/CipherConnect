...
// Add resize event listener
    ...
    socket.on('friendsToGroup', (data) => {
        ...
        data.forEach((friend) => {
            ...
            const checkbox = document.createElement('input'); // Create the checkbox inside the loop
        ...
        // Append all the user divs to the modal content
        modalContent.appendChild(fragment);
    
        // Now, add event listeners after appending the checkboxes
        let checkedItems = [];
        ...
        checkboxes.forEach((checkbox) => {
            checkbox.addEventListener('change', function() {
                ...
                if (this.checked) {
                    // Add the corresponding text to the array when checked
                    checkedItems.push(textContent);
                } else {
                    // Remove the corresponding text from the array when unchecked
                    checkedItems = checkedItems.filter(item => item !== textContent);
                }
